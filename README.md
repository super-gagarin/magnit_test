...
Данный репозиторий создан для прохождения тестирования компании Магнит соискателей на должность 'Разработчик на Pythone'.<br />
  Директория "Решение задания 1" содержит соотвественно решения по заданию 1: <br />
    ...
    <a href='[https://github.com/super-gagarin/magnit_test/blob/main/Решение%20задания%202.sql](https://github.com/super-gagarin/magnit_test/blob/main/Решение%20задание%201/Решение%20задания%202.sql)'>Решение задания 1.sql - листинг на SQL, для СУБД PostgreSQL ver. 14.2</a><br />
